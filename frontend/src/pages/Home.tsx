...
const Home = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* SECTION INFOS */}
      <section className="py-12 bg-white relative z-20 -mt-10 mx-4 md:mx-10 rounded-2xl shadow-xl border border-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-8">
            <div className="flex flex-col items-center text-center">
                <div className="bg-primary/10 p-4 rounded-full text-primary mb-4">
                    <Clock size={32} />
                </div>
                <h3 className="font-display text-xl font-bold text-dark mb-2">Ouvert 7j/7</h3>
                <p className="text-gray-500">11h30 - 14h30 <br/> 18h30 - 22h30</p>
            </div>
            <div className="flex flex-col items-center text-center border-l border-r border-gray-100 px-4">
                <div className="bg-primary/10 p-4 rounded-full text-primary mb-4">
                    <MapPin size={32} />
                </div>
                <h3 className="font-display text-xl font-bold text-dark mb-2">Marseille 6ème</h3>
                <p className="text-gray-500">24 Bd Notre Dame<br/>13006 Marseille</p>
            </div>
            <div className="flex flex-col items-center text-center">
                <div className="bg-primary/10 p-4 rounded-full text-primary mb-4">
                    <Phone size={32} />
                </div>
                <h3 className="font-display text-xl font-bold text-dark mb-2">Livraison & Emporter</h3>
                <p className="text-gray-500 font-bold text-lg">04 91 555 444</p>
            </div>
        </div>
      </section>
